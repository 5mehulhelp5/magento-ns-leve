 ...
 */
namespace Adrocket\ShippingCostCalculator\Controller\Index;
...
class Index extends \Magento\Framework\App\Action\Action
{
    ...
    public function __construct(
        ...
        \Adrocket\ShippingCostCalculator\Helper\Data $helper,
        ProductRepositoryInterface $productRepository
    ) {
        parent::__construct($context);
        $this->resultJsonFactory = $resultJsonFactory;
        $this->helper = $helper;
        $this->shippingManager = $this->_objectManager->get('Adrocket\ShippingCostCalculator\Model\ShippingMethodManagement');
