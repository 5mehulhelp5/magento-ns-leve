define([
    ...
    $.widget('mage.installment', {
        ...
        initPricesInCart: function (total = null) {
            $('#cart-totals .adrocket-installment').remove();
            ...
            if (total) {
                ...
                if (installments) {
                    ...
                    $('#cart-totals').append('<div class="adrocket-installment">' + html + '</div>');
                }
            }
        ...
        updateAllInstallments: function (priceElement, prices = null) {
            ...
            if (installments) {
                ...
                html += '</ul>';
                $('.adrocket-installment .all-installments-content').html(html);
            }
        },
        /**
         *
        ...
        renderPrices: function (priceElement, prices = null) {
            ...
            if (installments) {
                ...
                let installmentDiv = ($(priceElement).closest('.adrocket-installment').length > 0) ? $(priceElement).closest('.adrocket-installment') : null;
                if (installmentDiv) {
                    $(priceElement).insertBefore($(installmentDiv));
                    $(installmentDiv).html(template);
                } else {
                    installmentDiv = $('<div class="adrocket-installment">' + template + '</div>');
